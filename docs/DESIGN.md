...
| **M1** faithful core (done; reporters — GitLab Code Quality, SARIF, GitHub annotations — with file/line locations from kustomize origin tracking added later; differential tests against kustomize-controller still open) | in-process kustomize, Flux post-processing, config + externals, `FL-G001–5/8`, `FL-S001/2/4`, `FL-T001/2/4–8/100`, text + JSON reports, synthetic fixtures |
